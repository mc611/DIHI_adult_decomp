...
def main():
    input_file = "../../../../../Data/Processed/features/analytes/gap_analysis/lab_icu_freq_temp.csv"
    output_file = "../../../../../Data/Processed/features/analytes/gap_analysis/lab_icu_freq.csv"
