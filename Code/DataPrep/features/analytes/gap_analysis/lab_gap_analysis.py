...
def main():
    ...
    freq_df = gap_analysis_freq('component_name', lab_icu_freq, lab_no_icu_freq, 6550, 170663)
    freq_6hrs_df = gap_analysis_freq('component_name', lab_icu_freq_6hrs, lab_no_icu_freq, 6550, 170663)
