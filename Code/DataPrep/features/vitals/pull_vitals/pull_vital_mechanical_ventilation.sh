...
# pull cohort mechanical ventilation data from raw data

grouper_file='P:/dihi_qi/data_pipeline/metadata/vitals_grouping/data/groupers/Mechanical_Ventilation.csv'
output_file='../../../../../Data/Processed/features/vitals/mechanical_ventilation/mechanical_ventilation.csv'
