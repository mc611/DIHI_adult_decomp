...
# pull cohort respiratory rate data from raw data

grouper_file='P:/dihi_qi/data_pipeline/metadata/vitals_grouping/data/groupers/Respiratory_Rate.csv'
output_file='../../../../../Data/Processed/features/vitals/respiratory_rate/respiratory_rate.csv'
