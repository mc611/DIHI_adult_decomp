...
# pull cohort temperature data from raw data

grouper_file='P:/dihi_qi/data_pipeline/metadata/vitals_grouping/data/groupers/Temperature.csv'
output_file='../../../../../Data/Processed/features/vitals/temperature/temperature.csv'
