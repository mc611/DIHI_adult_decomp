...
# pull cohort pulse data from raw data

grouper_file='P:/dihi_qi/data_pipeline/metadata/vitals_grouping/data/groupers/Pulse.csv'
output_file='../../../../../Data/Processed/features/vitals/pulse/pulse.csv'
