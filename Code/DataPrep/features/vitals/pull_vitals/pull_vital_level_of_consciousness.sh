...
# pull level of consciousness data from raw data

grouper_file='P:/dihi_qi/data_pipeline/metadata/vitals_grouping/data/groupers/Level_Of_Consciousness.csv'
output_file='../../../../../Data/Processed/features/vitals/level_of_consciousness/level_of_consciousness.csv'
