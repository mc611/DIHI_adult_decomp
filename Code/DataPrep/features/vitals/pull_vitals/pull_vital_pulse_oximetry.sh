...
# pull cohort pulse oximetry data from raw data

grouper_file='P:/dihi_qi/data_pipeline/metadata/vitals_grouping/data/groupers/Pulse_Oximetry.csv'
output_file='../../../../../Data/Processed/features/vitals/pulse_oximetry/pulse_oximetry.csv'
