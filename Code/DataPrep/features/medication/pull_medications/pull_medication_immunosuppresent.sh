...
output_file='../../../../../Data/Processed/features/medications/immunosuppresent/immunosuppresent.csv'
...
do
    ...
    awk -vFPAT='([^,]*)|("[^"]+")' -vOFS=, 'FNR==NR{a[$1]++;next};(FNR+35)==NR{b[$1]++;next};a[$4]&&b[$2]' \
    ../../../../../Data/Processed/features/medications/immunosuppresent/immunosuppresent_names.csv \
