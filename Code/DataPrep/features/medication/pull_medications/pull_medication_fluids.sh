...
output_file='../../../../../Data/Processed/features/medications/fluids/fluids.csv'
...
do
    ...
    awk -F , 'FNR==NR{a[$1]++;next};(FNR+10)==NR{b[$1]++;next};a[$4]&&b[$2]' \
    ../../../../../Data/Processed/features/medications/fluids/fluids_names.csv \
