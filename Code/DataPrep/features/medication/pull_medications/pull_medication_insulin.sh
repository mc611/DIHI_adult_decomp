...
output_file='../../../../../Data/Processed/features/medications/insulin/insulin.csv'
...
do
    ...
    awk -F , 'FNR==NR{a[$1]++;next};(FNR+9)==NR{b[$1]++;next};a[$4]&&b[$2]' \
    ../../../../../Data/Processed/features/medications/insulin/insulin_names.csv \
