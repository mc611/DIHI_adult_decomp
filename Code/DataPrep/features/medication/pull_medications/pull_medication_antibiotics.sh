...
output_file='../../../../../Data/Processed/features/medications/antibiotics/antibiotics.csv'
...
do
    ...
    awk -vFPAT='([^,]*)|("[^"]+")' -vOFS=, 'FNR==NR{a[$1]++;next};(FNR+61)==NR{b[$1]++;next};a[$4]&&b[$2]' \
    ../../../../../Data/Processed/features/medications/antibiotics/antibiotics_names.csv \
